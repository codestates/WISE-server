...
const createReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const totalReviews = yield review_1.default.find({ service: existingOrder === null || existingOrder === void 0 ? void 0 : existingOrder.service })
            .countDocuments();
        const newStarRating = totalReviews === 1 ? ((existingService === null || existingService === void 0 ? void 0 : existingService.starRating) + starRating)
            : ((existingService === null || existingService === void 0 ? void 0 : existingService.starRating) + starRating) / totalReviews;
