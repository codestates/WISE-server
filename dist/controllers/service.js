...
exports.deleteService = exports.updateService = exports.createService = exports.getAllServices = exports.getScheduleByServices = exports.getPopularServices = exports.getServicesBySearch = exports.getService = void 0;
...
const getServicesBySearch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getServicesBySearch = getServicesBySearch;
...
const getScheduleByServices = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { serviceId } = req.query;
        const existingServices = yield service_1.default.findById(serviceId).select('availableDays').lean();
        const existingOrders = yield order_1.default.find({ service: serviceId }).select('date time');
        const orders = [];
        existingOrders.forEach((element) => {
            orders.push(`${moment_1.default(element.date).format('YYYY-MM-DD')} ${element.time}`);
        });
        return res.status(200).json({
...
exports.getScheduleByServices = getScheduleByServices;
...
const createService = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingService = yield service_1.default.findOne({ assistant: existingUser === null || existingUser === void 0 ? void 0 : existingUser._id })
            .populate('assistant', 'name')
            .lean();
...
const updateService = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedService = yield service_1.default.findById(service._id)
            .populate('assistant', 'name')
            .lean();
        return res.status(200).json({
