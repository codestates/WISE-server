...
router.get('/services', service_2.getServices);
...
router.patch('/services/:serviceId', auth_1.default, service_1.isSameAssistant, s3_1.upload.fields([
    { name: 'images', maxCount: 3 },
    { name: 'trainingCert', maxCount: 3 },
    { name: 'orgAuth', maxCount: 3 },
]), service_2.updateService);
router.delete('/services/:serviceId', auth_1.default, service_1.isSameAssistant, service_2.deleteService);
